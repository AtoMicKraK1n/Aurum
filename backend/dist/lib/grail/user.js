...
function extractUserRow(item) {
    ...
    const userPda = typeof row.userPda === "string"
        ...
        : typeof row.pda === "string"
            ? row.pda
            : undefined;
    const walletAddress = typeof row.userWalletAddress === "string"
    ...
    const metadata = row.metadata && typeof row.metadata === "object"
        ? row.metadata
        : undefined;
    const referenceId = typeof row.referenceId === "string"
        ? row.referenceId
...
function pickMatchingUserByWallet(payload, walletAddress) {
